...
public class MultigramGraphSupervised_UnigramFully {
...
private void trigramTranslationProbability(HashMap translationBigram, HashMap translationTrigram, HashMap TrigramTranslatProb){
	...
	public void main(ArrayList test, Double threshold, int tiRules, int semiIteration, 
			ArrayList seed, HashMap gemmaNew,
			HashMap graph, int charAlign, ArrayList lmCorpusSrc, ArrayList lmCorpusTar, int nontiOrder) {
		// seed is input here which is labelled data
		...
		MultigramGraphSupervised_UnigramFully obj = new MultigramGraphSupervised_UnigramFully();
...
*/
		...
		o.test(test, translationTest1, 1); //unigram
...
//		o.test(inputSeed, obj.translation, 1);
	...
	//	inputSeed = new ArrayList();
	//	inputSeed.addAll(seed);
	// this loop is only to get multigrams with initial probability
		...
		//testObj.main(seed, gemmaNew, graph, -500.0, test, translationTest1, totalEdgesInTrain, tiRules, charAlign, obj.LAMBDA,
		//threshold);
		semiTest_supervised testObj = new semiTest_supervised();
		testObj.main(seed, gemmaNew, graph, -500.0, test, translationTest1, totalEdgesInTrain, tiRules, charAlign, obj.LAMBDA,
				threshold, totalFreq);
// the unsmoothed tranlsation model is in obj.translationTest
	}
