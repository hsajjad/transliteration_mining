...
public class MultigramGraphSupervised_Bigram {
	...
	public void main(ArrayList input, ArrayList test, Double threshold,
		...
		MultigramGraphSupervised_Bigram obj = new MultigramGraphSupervised_Bigram();
...
*/		
		...
		for (int i = 0; i < 1; i++) { // EM loop
			...
			String temp = "";
			if(i+1 < 1){ // last iteration do bigram stuff as well
