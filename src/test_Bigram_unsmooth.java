...
public class test_Bigram_unsmooth {
	...
	private void bigramViterbiProb(HashMap gemmaOld, HashMap aGivenb, String viterbiStr){
	...
	public void main(ArrayList input, HashMap gemmaNew, HashMap graph, ArrayList test,
			HashMap translationTest, int tiRules, int charAlign, Double lambda, Double threshold, HashMap aGivenb) {
		...
		test_Bigram_unsmooth obj = new test_Bigram_unsmooth();
		...
		while (itInput.hasNext()) {
			...
			obj.bigramViterbiProb(gemmaOld, aGivenb, viterbiString);
