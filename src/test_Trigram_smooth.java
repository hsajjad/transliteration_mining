...
public class test_Trigram_smooth {
	...
	public void main(ArrayList input, HashMap gemmaNew, HashMap graph, Double alphaWB, ArrayList test,
			...
			HashMap backoffEstimates, Double lambda, HashMap aGivenbc, HashMap backoffEstimateBC, double totalFreq) {
		...
		test_Trigram_smooth obj = new test_Trigram_smooth();
