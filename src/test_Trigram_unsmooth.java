...
public class test_Trigram_unsmooth {
	...
	private void trigramViterbiProb(HashMap gemmaOld, String viterbiStr, HashMap aGivenbc){
	...
	public void main(ArrayList input, HashMap gemmaNew, HashMap graph, Double alphaWB, ArrayList test,
			HashMap translationTest, int totalEdgesInTrain, int tiRules, int charAlign, Double lambda, HashMap aGivenbc) {
	...
	//  HashMap<Integer, Double> seedEditDistance = new HashMap<Integer, Double>();
		...
		test_Trigram_unsmooth obj = new test_Trigram_unsmooth();
...
*/				}
				...
				obj.trigramViterbiProb(gemmaOld, viterbiString, aGivenbc);
