...
public class MultigramGraphSemi_traintest {
	...
	public void main(ArrayList input, ArrayList test, Double threshold,
		...
		MultigramGraphSemi_traintest obj = new MultigramGraphSemi_traintest();
...
//		Iterator tplus = trainPlusTest.keySet().iterator();
		Iterator tplus = inputSeed.iterator();
		while (tplus.hasNext()) {
...
*/		
	...
	//			charAlign, obj.LAMBDA, threshold, seed);
		...
		testObj.main(input, gemmaNew, graph, alphaWB, test, translationTest1, totalEdgesInTrain, tiRules,
				charAlign, obj.LAMBDA, threshold, totalFreq);
	}
