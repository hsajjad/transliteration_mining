...
public class semiTest_smooth {
	...
	public void printViterbiAlignments(HashMap gDepth) {
		...
		double aaaaa = Math.pow(10, alphaTotal);
		double aaaa = aaaaa * 0.1;
		...
		String str = srcStr + "\t" + tarStr + "\t" + Math.pow(10, alphaTotal);
	...
	private double calculateM(ArrayList input, ArrayList test)
	{
		...
		//Double unknownScore = (200) * (200) * 1.0;
	...
	public void main(ArrayList input, HashMap gemmaNew, HashMap graph, Double alphaWB, ArrayList test,
		...
		lambda = Math.log10(0.5); // reestimating for test as it is a different test 
		...
		semiTest_smooth obj = new semiTest_smooth();
		obj.translation.putAll(translationTest);
		
	//	printingHashNum(translationTest, "nontransliteration");
	//	obj.printGemma(gemmaNew, "transliterationUnits");
