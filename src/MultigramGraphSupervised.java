// do step 1 of semi supervised and them drop unlabelled data and its multigrams. No step 2
// then test only using the multigrams from the seed


import java.io.*;
import java.util.*;

public class MultigramGraphSupervised {
	...
	public void main(ArrayList input, ArrayList test, Double threshold,
		...
		MultigramGraphSupervised obj = new MultigramGraphSupervised();
		...
		System.out.println("gemmaInput" + gemmaInput.size());
		System.out.println("gemmaSeed" + gemmaSeed.size());
